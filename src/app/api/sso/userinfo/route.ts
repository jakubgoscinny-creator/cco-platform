 ...
 *
 * Circle reads these fields per its SSO config response-path mapping:
 *   - sub   → User ID response path
 *   - email → User Email response path
 *   - name  → User Name response path
 *
 * Restored for CCO-T032 — see the history note in src/lib/sso.ts.
 */
